...
let b = 5*5;
let S = 45*21;
let squares = Math.floor(S/b);
console.log(`Количество квадратиков, которые можно разместить: ${squares}`);

let i1 = 2;
let a1 = ++i1;
let b1 = i1++;
if(a1 > b1){
    console.log('Первое значение больше, чем второе');
}
else if(a1 < b1){
...
do {
    let userName = prompt("Введите имя: ").toLowerCase();
